...
const Suggestions: React.FC = () => {
  ...
  return (
    <div className="m-0 p-0">
      <div className="flex justify-between items-center bg-indigo-dark pl-6 pr-3 py-2 mb-8 md:mx-10 md:rounded-large md:py-3.5">
        <div className="invisible h-0 md:visible md:h-6">
          <svg
